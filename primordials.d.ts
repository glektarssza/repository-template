...
type TypedArrayContentType<T extends TypedArray> =
    T extends {[k: number]: infer V} ? V : never;
...
declare namespace primordials {
    ...
    >;
    export const ArrayPrototypeToSorted: UncurryThis<
    ...
    >;
    export const ArrayPrototypeSymbolIterator: UncurryMethod<
    ...
    export const ArrayBufferPrototypeGetDetached: UncurryGetter<
        typeof ArrayBuffer.prototype,
        'detached'
    >;
    export const ArrayBufferPrototypeSlice: UncurryThis<
        typeof ArrayBuffer.prototype.slice
    >;
    export const ArrayBufferPrototypeTransfer: UncurryThis<
        typeof ArrayBuffer.prototype.transfer
    >;
    ...
    >;
    export const DataViewPrototypeGetBuffer: UncurryGetter<
        typeof DataView.prototype,
        'buffer'
    >;
    export const DataViewPrototypeGetByteLength: UncurryGetter<
        typeof DataView.prototype,
        'byteLength'
    >;
    export const DataViewPrototypeGetByteOffset: UncurryGetter<
        typeof DataView.prototype,
        'byteOffset'
    >;
    ...
    >;
    export const FunctionPrototypeSymbolHasInstance: UncurryMethod<
    ...
    export const MapPrototypeGetSize: UncurryGetter<
        typeof Map.prototype,
        'size'
    >;
    ...
    export const RegExpPrototypeGetDotAll: UncurryGetter<
        typeof RegExp.prototype,
        'dotAll'
    >;
    export const RegExpPrototypeGetFlags: UncurryGetter<
        typeof RegExp.prototype,
        'flags'
    >;
    export const RegExpPrototypeGetGlobal: UncurryGetter<
        typeof RegExp.prototype,
        'global'
    >;
    export const RegExpPrototypeGetIgnoreCase: UncurryGetter<
        typeof RegExp.prototype,
        'ignoreCase'
    >;
    export const RegExpPrototypeGetMultiline: UncurryGetter<
        typeof RegExp.prototype,
        'multiline'
    >;
    export const RegExpPrototypeGetSource: UncurryGetter<
        ...
        'source'
    >;
    export const RegExpPrototypeGetSticky: UncurryGetter<
        typeof RegExp.prototype,
        'sticky'
    >;
    export const RegExpPrototypeGetUnicode: UncurryGetter<
        typeof RegExp.prototype,
        'unicode'
    >;
    export const RegExpPrototypeSymbolReplace: UncurryMethod<
        typeof RegExp.prototype,
        typeof Symbol.replace
    >;
    export const RegExpPrototypeSymbolSplit: UncurryMethod<
        typeof RegExp.prototype,
        typeof Symbol.split
    >;
    ...
    export const SetPrototypeGetSize: UncurryGetter<
        typeof Set.prototype,
        'size'
    >;
    ...
    export const StringFromCharCodeApply: StaticApply<
        typeof String.fromCharCode
    >;
    export const StringFromCodePoint: typeof String.fromCodePoint;
    export const StringFromCodePointApply: StaticApply<
        typeof String.fromCodePoint
    >;
    ...
    >;
    export const SymbolPrototypeSymbolToPrimitive: UncurryMethod<
        typeof Symbol.prototype,
        typeof Symbol.toPrimitive,
        symbol | Symbol
    >;
    export const SymbolPrototypeGetDescription: UncurryGetter<
        typeof Symbol.prototype,
        'description',
        symbol | Symbol
    >;
    ...
    export function TypedArrayFrom<
    ...
    export const TypedArrayPrototypeGetBuffer: UncurryGetter<
        TypedArray,
        'buffer'
    >;
    export const TypedArrayPrototypeGetByteLength: UncurryGetter<
        TypedArray,
        'byteLength'
    >;
    export const TypedArrayPrototypeGetByteOffset: UncurryGetter<
        TypedArray,
        'byteOffset'
    >;
    export const TypedArrayPrototypeGetLength: UncurryGetter<
        TypedArray,
        'length'
    >;
